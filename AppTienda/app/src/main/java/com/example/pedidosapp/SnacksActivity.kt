...
import com.example.pedidosapp.databinding.ActivitySnacksBinding
...
class SnacksActivity : AppCompatActivity() {
    ...
    private lateinit var binding : ActivitySnacksBinding
    private lateinit var producList : ArrayList<ItemProduct>
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySnacksBinding.inflate(layoutInflater)

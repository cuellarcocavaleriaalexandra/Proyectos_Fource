...
import com.example.pedidosapp.databinding.ActivityCarnesBinding
...
class CarnesActivity : AppCompatActivity() {
    ...
    private lateinit var binding : ActivityCarnesBinding
    private lateinit var producList : ArrayList<ItemProduct>
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityCarnesBinding.inflate(layoutInflater)
    ...
    private fun llamarrecyclerview() {
        ...
        db.collection("Productos")
            .whereEqualTo("Tipo", "Carnes frías")
            .get()

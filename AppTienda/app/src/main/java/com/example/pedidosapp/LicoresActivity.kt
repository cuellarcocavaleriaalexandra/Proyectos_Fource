...
import com.example.pedidosapp.databinding.ActivityLicoresBinding
...
class LicoresActivity : AppCompatActivity() {
    ...
    private lateinit var binding : ActivityLicoresBinding
    private lateinit var producList : ArrayList<ItemProduct>
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLicoresBinding.inflate(layoutInflater)
    ...
    private fun llamarrecyclerview() {
        ...
        db.collection("Productos")
            .whereEqualTo("Tipo", "Licores y tabaco")
            .get()

...
import com.example.pedidosapp.databinding.ActivityLacteosBinding
import com.google.firebase.firestore.FirebaseFirestore

class LacteosActivity : AppCompatActivity() {
    val db = FirebaseFirestore.getInstance()

    private lateinit var adapterproduct : AdapterTipoProductos
    private lateinit var binding : ActivityLacteosBinding
    private lateinit var producList : ArrayList<ItemProduct>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLacteosBinding.inflate(layoutInflater)

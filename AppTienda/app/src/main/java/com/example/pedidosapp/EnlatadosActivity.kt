...
class EnlatadosActivity : AppCompatActivity() {
    val db = FirebaseFirestore.getInstance()

    private lateinit var adapterproduct : AdapterTipoProductos
    private lateinit var binding : ActivityEnlatadosBinding
    private lateinit var producList : ArrayList<ItemProduct>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityEnlatadosBinding.inflate(layoutInflater)

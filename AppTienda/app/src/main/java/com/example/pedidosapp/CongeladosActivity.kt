...
import com.example.pedidosapp.databinding.ActivityCongeladosBinding
...
class CongeladosActivity : AppCompatActivity() {
    ...
    private lateinit var binding : ActivityCongeladosBinding
    private lateinit var producList : ArrayList<ItemProduct>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCongeladosBinding.inflate(layoutInflater)
